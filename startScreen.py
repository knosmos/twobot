...
def startLevel(name):
    ...
    runLevel.win = False
    runLevel.end = False
    runLevel.headingNode.setH(45+180)
...
toggleButton('shadows',toggleShadows,-0.5).reparentTo(settings)
toggleButton('debug mode',toggleDebug,-0.75,default=0).reparentTo(settings)
